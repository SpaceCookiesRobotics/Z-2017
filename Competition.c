...
#pragma config(Motor,  port6,           blah,          tmotorNone, openLoop)
...
//	AutonRedRight();
	 ...
	 while(1 == 1)
  {
    ...
    motor[rightFront] = vexRT[Ch1] - vexRT[Ch2];
    motor[rightBack] =  vexRT[Ch1] - vexRT[Ch2];

    //Lift
    motor[Motor5] = vexRT[Ch3Xmtr2];
    motor[Motor6] = vexRT[Ch3Xmtr2];
    motor[Motor8] = vexRT[Ch3Xmtr2];
    motor[Motor9] = vexRT[Ch3Xmtr2];
